#ifndef INCLUDED_MAX_FLOW_SOLVERS_PREFLOW_PUSH_HIGHEST_LABEL
#define INCLUDED_MAX_FLOW_SOLVERS_PREFLOW_PUSH_HIGHEST_LABEL
...
namespace MaxFlow::Solvers::PreflowPush
{
	...
	class HighestLabelPreflowPushSolver final : public PreflowPushSolver
	{
